...
export class ContentPacksPopup extends React.Component<any, any> {
    steps: any;
    ...
    render() {
        const { modal, isSubmitted, global, node, title, bindAddress, port, reciveBufferSize, noOfWorkerthreads, tlsCertFile, tlsPrivateKeyFile, enableTls, tlsKeyPassword, tlsClientAuthentication, tlsClientAuthTrustedCerts, tcpKeepAlive, nullFrameDelimiter, overrideSource, forceRDns, allowOverridingDate, storeFullMessage, expandStructuredData,name,summary } = this.state;
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                    ...
                                    <input type="text" id="name" name="name" value={name} onChange={this.onStateChange} className="input-group-text" />
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                    ...
                                    <input type="text" id="summary" name="summary" value={summary} onChange={this.onStateChange} className="input-group-text" placeholder="A description name of stream" />
                                    <span></span>
                                </div>
                            </div>
                        </div>
